    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '0101Z1', name: '文化哲学' },
          { code: '0101Z2', name: '国学' },
          { code: '0101J1', name: '中国古典学' },
        ],
      },
    ],
  },
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '0201Z1', name: '法经济学' },
          { code: '0201Z2', name: '比较经济体制学' },
          { code: '0201Z3', name: '发展经济学' },
          { code: '0201J1', name: '朝鲜韩国学' },
          { code: '0201J7', name: '乡村振兴学' },
          { code: '0201Z4', name: '数字经济学' },
          { code: '0201Z5', name: '中国特色社会主义政治经济学' },
          { code: '0201Z6', name: '数字经济学' },
        ],
      },
      {
        code: '0202',
        ...
        majors: [
          ...
          { code: '0202Z1', name: '保险学' },
          { code: '0202Z2', name: '保险学' },
          { code: '0202Z3', name: '低空经济学' },
          { code: '0202J1', name: '国际商务与管理' },
          { code: '0202J2', name: '劳动关系' },
          { code: '0202J5', name: '农业经济学' },
          { code: '0202Z4', name: '能源与低碳经济学' },
          { code: '0202Z5', name: '投资学' },
          { code: '0202Z6', name: '保险学' },
          { code: '0202Z7', name: '保险学' },
          { code: '0202Z8', name: '消费经济学' },
          { code: '0202Z9', name: '流通经济学' },
        ],
      },
      {
        code: '0270',
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '0301J1', name: '司法鉴定学' },
          { code: '0301J2', name: '国家安全学' },
          { code: '0301J3', name: '劳动关系学' },
          { code: '0301J4', name: '人权法学' },
          { code: '0301J5', name: '法治文化' },
          { code: '0301J8', name: '涉外法治' },
          { code: '0301Z1', name: '人权法学' },
          { code: '0301Z2', name: '世界贸易组织法' },
          { code: '0301Z3', name: '知识产权与人工智能法学' },
          { code: '0301Z4', name: '党内法规学' },
          { code: '0301Z5', name: '刑事司法学' },
          { code: '0301Z6', name: '人权法学' },
          { code: '0301Z7', name: '教育法学' },
          { code: '0301Z8', name: '智能法学' },
          { code: '0301Z9', name: '人工智能法学' },
        ],
      },
      {
        code: '0302',
        ...
        majors: [
          ...
          { code: '0302J1', name: '朝鲜韩国学' },
          { code: '0302J2', name: '法律政治学' },
          { code: '0302J3', name: '国际组织与全球治理' },
          { code: '0302Z1', name: '国际组织与全球治理' },
          { code: '0302Z2', name: '区域国别研究' },
          { code: '0302Z3', name: '中国学' },
          { code: '0302Z4', name: '政府经济学' },
          { code: '0302Z5', name: '国际组织与国际公共政策' },
          { code: '0302Z6', name: '国家安全战略与管理' },
        ],
      },
      {
        code: '0303',
        ...
        majors: [
          ...
          { code: '0303J6', name: '乡村学' },
          { code: '0303Z1', name: '边疆社会研究' },
          { code: '0303Z2', name: '社会心理学' },
          { code: '0303Z3', name: '女性学' },
        ],
      },
      {
        code: '0304',
        ...
        majors: [
          ...
          { code: '030406', name: '中华民族学' },
          { code: '030407', name: '人类学与世界民族' },
          { code: '0304J1', name: '中华民族共同体学' },
          { code: '0304J2', name: '中华民族共同体学' },
          { code: '0304J7', name: '中华民族共同体学' },
          { code: '0304J8', name: '中华民族共同体学' },
          { code: '0304J9', name: '中国边疆学' },
        ],
      },
      {
        code: '0305',
        ...
        majors: [
          ...
          { code: '0305J1', name: '中华民族共同体学' },
          { code: '0305J2', name: '经济哲学' },
          { code: '0305J9', name: '公共安全与涉外法治' },
          { code: '0305Z1', name: '中国特色社会主义政治经济学' },
          { code: '0305Z2', name: '中国学' },
          { code: '0305Z3', name: '习近平新时代中国特色社会主义思想研究' },
        ],
      },
      {
        code: '0306',
        ...
        majors: [
          ...
          { code: '0306Z1', name: '治安学' },
          { code: '0306Z2', name: '侦查学' },
          { code: '0306Z3', name: '犯罪学' },
          { code: '0306Z4', name: '公安管理学' },
          { code: '0306Z6', name: '公安党建与思政' },
        ],
      },
      {
        code: '0307',
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '0401J1', name: '家政学' },
          { code: '0401J3', name: '教师教育' },
          { code: '0401J4', name: '教师教育学' },
          { code: '0401Z1', name: '体育教育学' },
          { code: '0401Z2', name: '互联网教育' },
          { code: '0401Z3', name: '少年儿童组织与思想意识教育' },
          { code: '0401Z4', name: '初等教育学' },
          { code: '0401Z5', name: '基础教育学' },
          { code: '0401Z6', name: '小学教育学' },
          { code: '0401Z7', name: '学科教育学' },
        ],
      },
      {
        code: '0402',
        ...
        majors: [
          ...
          { code: '0402Z1', name: '儿童发展科学' },
          { code: '0402Z2', name: '临床认知神经科学' },
        ],
      },
      {
        code: '0403',
        ...
        majors: [
          ...
          { code: '0403Z1', name: '冰雪运动学' },
          { code: '0403Z2', name: '中外体育人文交流' },
          { code: '0403Z3', name: '体育新闻传播学' },
          { code: '0403Z4', name: '休闲体育学' },
          { code: '0403Z5', name: '体育翻译' },
          { code: '0403Z6', name: '中外体育史' },
          { code: '0403Z7', name: '体育艺术学' },
        ],
      },
      {
        code: '0471',
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '0501J1', name: '儿童文学' },
          { code: '0501J2', name: '语文教育' },
          { code: '0501J8', name: '文化创意与文化产业' },
          { code: '0501Z1', name: '中华文化国际传播' },
          { code: '0501Z2', name: '中国民间文学' },
          { code: '0501Z3', name: '写作学' },
          { code: '0501Z4', name: '民间文学与文化' },
          { code: '0501Z5', name: '心理语言学' },
          { code: '0501Z6', name: '语言资源学' },
          { code: '0501Z7', name: '语言认知科学' },
          { code: '0501Z8', name: '世界汉学与中国学' },
          { code: '0501Z9', name: '文献语言学' },
        ],
      },
      {
        code: '0502',
        ...
        majors: [
          ...
          { code: '0502J1', name: '国别与区域研究' },
          { code: '0502J2', name: '外语教育' },
          { code: '0502Z1', name: '区域国别研究' },
          { code: '0502Z2', name: '全球传播' },
          { code: '0502Z3', name: '语言与人工智能' },
          { code: '0502Z4', name: '国别和区域研究' },
          { code: '0502Z5', name: '国际传播' },
          { code: '0502Z6', name: '国别与区域研究' },
          { code: '0502Z7', name: '国别和区域研究' },
        ],
      },
      {
        code: '0503',
        ...
        majors: [
          ...
          { code: '0503J2', name: '新媒体' },
          { code: '0503J4', name: '互联网信息' },
          { code: '0503J5', name: '信息传播学' },
          { code: '0503J7', name: '文化发展与传播' },
          { code: '0503J8', name: '新闻舆论学' },
          { code: '0503Z1', name: '出版学' },
          { code: '0503Z2', name: '传媒经济学' },
          { code: '0503Z3', name: '传媒经济学' },
          { code: '0503Z4', name: '编辑出版学' },
          { code: '0503Z5', name: '国际新闻学' },
          { code: '0503Z7', name: '国际传播学' },
        ],
      },
      {
        code: '0570',
    ...
    disciplines: [
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '0602Z1', name: '当代中国史' },
          { code: '0602Z2', name: '华侨华人与国际移民' },
          { code: '0602J1', name: '敦煌学' },
          { code: '0602J3', name: '边疆学(边疆政治学,边疆经济学,边疆社会学,边疆史地)' },
          { code: '0602J6', name: '革命文物学' },
          { code: '0602Z3', name: '方志学' },
        ],
      },
      {
        code: '0603',
        ...
        majors: [
          ...
          { code: '0603J1', name: '朝鲜韩国学' },
          { code: '0603Z1', name: '古典学' },
          { code: '0603Z2', name: '亚述学和埃及学' },
        ],
      },
    ],
  },
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '0701J1', name: '数据科学' },
          { code: '0701J2', name: '大数据科学与技术' },
          { code: '0701J7', name: '生物数学与数据智能' },
          { code: '0701Z1', name: '数据智能分析与应用' },
          { code: '0701Z2', name: '数学技术' },
        ],
      },
      {
        code: '0702',
        ...
        majors: [
          ...
          { code: '0702J1', name: '集成电路科学与工程' },
          { code: '0702Z1', name: '光电子学' },
          { code: '0702Z2', name: '材料物理' },
          { code: '0702Z3', name: '量子科学与技术' },
        ],
      },
      {
        code: '0703',
        ...
        majors: [
          ...
          { code: '0703J1', name: '低碳能源化学与工程' },
          { code: '0703Z1', name: '分子光电科学' },
          { code: '0703Z2', name: '制药化学' },
          { code: '0703Z3', name: '化学生物学' },
          { code: '0703Z4', name: '绿色化学' },
        ],
      },
      {
        code: '0704',
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '0705J1', name: '海洋可持续发展' },
          { code: '0705J2', name: '国家公园学' },
          { code: '0705Z1', name: '城市与区域规划' },
          { code: '0705Z2', name: '全球环境变化' },
          { code: '0705Z3', name: '地理教育学' },
          { code: '0705Z4', name: '自然灾害学' },
          { code: '0705Z5', name: '资源环境遥感' },
          { code: '0705Z7', name: '国土空间规划' },
        ],
      },
      {
        code: '0706',
        ...
        majors: [
          ...
          { code: '0706Z2', name: '应用气象学' },
          { code: '0706Z3', name: '3S集成与气象应用' },
          { code: '0706Z4', name: '雷电科学与技术' },
          { code: '0706Z5', name: '3S集成与气象应用' },
          { code: '0706Z6', name: '空间天气学' },
          { code: '0706Z9', name: '水文气象学' },
        ],
      },
      {
        code: '0707',
        ...
        majors: [
          ...
          { code: '0707J3', name: '海洋事务' },
          { code: '0707Z1', name: '海洋技术' },
          { code: '0707Z2', name: '海洋腐蚀与防护' },
        ],
      },
      {
        code: '0708',
        ...
        majors: [
          ...
          { code: '0708Z1', name: '地球动力学' },
          { code: '0708Z2', name: '地球与空间探测技术' },
        ],
      },
      {
        code: '0709',
        ...
        majors: [
          ...
          { code: '0709Z1', name: '宝石学' },
          { code: '0709Z2', name: '石油地质学' },
          { code: '0709Z3', name: '地震学' },
          { code: '0709Z4', name: '水文地质学' },
          { code: '0709Z5', name: '资源勘查与地球物理' },
          { code: '0709Z6', name: '遥感与地理信息系统' },
          { code: '0709Z8', name: '地球气候与环境' },
        ],
      },
      {
        code: '0710',
        ...
        majors: [
          ...
          { code: '0710J1', name: '生物医学信息学' },
          { code: '0710J2', name: '化学生物学' },
          { code: '0710J3', name: '合成生物学' },
          { code: '0710J5', name: '再生医学' },
          { code: '0710J6', name: '再生医学' },
          { code: '0710J7', name: '生物信息学' },
          { code: '0710Z1', name: '免疫生物学' },
          { code: '0710Z2', name: '医药信息学' },
          { code: '0710Z3', name: '医学遗传学' },
          { code: '0710Z4', name: '生物信息学' },
          { code: '0710Z6', name: '基因工程药物学' },
        ],
      },
      {
        code: '0711',
        ...
        majors: [
          ...
          { code: '0711J4', name: '海洋技术与装备' },
          { code: '0711J6', name: '碳中和科学与工程' },
        ],
      },
      {
        code: '0712',
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '0713J1', name: '国家公园学' },
          { code: '0713J3', name: '菌草学' },
          { code: '0713Z1', name: '生态信息科学' },
        ],
      },
      {
        code: '0714',
        ...
        majors: [
          ...
          { code: '0714J1', name: '大数据科学与应用' },
          { code: '0714J2', name: '大数据统计' },
          { code: '0714Z1', name: '经济社会统计' },
          { code: '0714Z2', name: '应用统计' },
          { code: '0714Z3', name: '大数据统计' },
          { code: '0714Z4', name: '应用统计' },
          { code: '0714Z5', name: '数理统计学' },
          { code: '0714Z7', name: '大数据统计方法与应用' },
        ],
      },
      {
        code: '0770',
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '0776Z1', name: '环境健康' },
          { code: '0776Z2', name: '环境管理' },
        ],
      },
      {
        code: '0777',
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '0801J7', name: '低空技术与工程' },
          { code: '0801J1', name: '低空技术与工程' },
          { code: '0801Z1', name: '智能制造与机器人' },
        ],
      },
      {
        code: '0802',
        ...
        majors: [
          ...
          { code: '0802J6', name: '低空技术与工程' },
          { code: '0802J7', name: '仿生与人形机器人' },
          { code: '0802J1', name: '低空技术与工程' },
          { code: '0802J2', name: '智能电动车辆' },
          { code: '0802J5', name: '智能制造装备与系统' },
          { code: '0802Z1', name: '包装工程' },
          { code: '0802Z2', name: '包装工程' },
          { code: '0802Z4', name: '交通装备检测及控制工程' },
          { code: '0802Z5', name: '智能电动车辆' },
        ],
      },
      {
        code: '0803',
        ...
        majors: [
          ...
          { code: '0803J1', name: '低空技术与工程' },
          { code: '0803Z1', name: '光电检测技术及仪器' },
        ],
      },
      {
        code: '0804',
        ...
        majors: [
          ...
          { code: '0804Z1', name: '光电检测与微电子学' },
          { code: '0804Z2', name: '电气测试技术与仪器' },
        ],
      },
      {
        code: '0805',
        ...
        majors: [
          ...
          { code: '0805Z2', name: '半导体材料与器件' },
          { code: '0805Z3', name: '电子封装' },
          { code: '0805Z4', name: '纳米材料与纳米技术' },
          { code: '0805J1', name: '储能科学与工程' },
          { code: '0805J4', name: '新能源科学与工程' },
          { code: '0805J5', name: '新能源科学与工程' },
          { code: '0805J8', name: '储能科学与工程' },
          { code: '0805Z1', name: '低维量子物理与材料' },
          { code: '0805Z5', name: '材料表面改性科学与技术' },
          { code: '0805Z6', name: '质量技术与标准化' },
        ],
      },
      {
        code: '0806',
        ...
        majors: [
          ...
          { code: '0806J4', name: '储能化学与物理' },
          { code: '0806Z1', name: '稀土工程' },
          { code: '0806Z2', name: '冶金能源工程' },
        ],
      },
      {
        code: '0807',
        ...
        majors: [
          ...
          { code: '0807J1', name: '储能科学与工程' },
          { code: '0807J2', name: '储能科学与工程' },
          { code: '0807J5', name: '新能源科学与工程' },
          { code: '0807Z1', name: '新能源技术和储能技术' },
          { code: '0807Z2', name: '储能科学与工程' },
        ],
      },
      {
        code: '0808',
        ...
        majors: [
          ...
          { code: '0808J1', name: '低碳能源化学与工程' },
          { code: '0808J3', name: '储能科学与工程' },
          { code: '0808Z1', name: '微纳电子与光电信息' },
          { code: '0808Z2', name: '能源与电工的新材料及器件' },
        ],
      },
      {
        code: '0809',
        ...
        majors: [
          ...
          { code: '0809Z1', name: '机电系统电子技术' },
          { code: '0809Z2', name: '光电工程' },
        ],
      },
      {
        code: '0810',
        ...
        majors: [
          ...
          { code: '0810J1', name: '低空技术与工程' },
          { code: '0810J2', name: '低空经济' },
          { code: '0810J4', name: '低空技术与工程' },
          { code: '0810J8', name: '新闻舆论学' },
          { code: '0810Z1', name: '信息安全' },
          { code: '0810Z2', name: '信息网络' },
        ],
      },
      {
        code: '0811',
        ...
        majors: [
          ...
          { code: '0811J1', name: '低空技术与工程' },
          { code: '0811J2', name: '储能科学与工程' },
          { code: '0811J5', name: '智能综合能源系统工程' },
          { code: '0811Z1', name: '光电系统与控制' },
        ],
      },
      {
        code: '0812',
        ...
        majors: [
          ...
          { code: '0812Z1', name: '低空技术与工程' },
          { code: '0812Z2', name: '人工智能' },
          { code: '0812Z3', name: '人工智能' },
          { code: '0812J1', name: '低空技术与工程' },
          { code: '0812J2', name: '低空技术与工程' },
          { code: '0812J3', name: '数据科学和信息技术' },
          { code: '0812J4', name: '低空智能技术与工程' },
          { code: '0812J5', name: '数据科学' },
          { code: '0812J6', name: '科学智能' },
          { code: '0812J9', name: '智能医学诊疗' },
        ],
      },
      {
        code: '0813',
        ...
        majors: [
          ...
          { code: '0813J1', name: '建筑遗产保护' },
          { code: '0813Z1', name: '城市与区域规划' },
        ],
      },
      {
        code: '0814',
        ...
        majors: [
          ...
          { code: '0814J1', name: '低空技术与工程' },
          { code: '0814J3', name: '城市地下空间工程' },
          { code: '0814J6', name: '安全科学与减灾' },
          { code: '0814Z1', name: '土木工程建造与管理' },
          { code: '0814Z2', name: '交通安全与灾害防治工程' },
          { code: '0814Z3', name: '道路交通工程与灾害防治' },
        ],
      },
      {
        code: '0815',
        ...
        majors: [
          ...
          { code: '0815J1', name: '风能工程' },
          { code: '0815Z1', name: '城市水务' },
          { code: '0815Z2', name: '岩土力学与工程' },
          { code: '0815Z3', name: '水灾害与水安全' },
        ],
      },
      {
        code: '0816',
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '0817J1', name: '化工安全' },
          { code: '0817J2', name: '储能科学与工程' },
          { code: '0817J3', name: '碳中和科学与工程' },
          { code: '0817J4', name: '合成生物学' },
          { code: '0817Z1', name: '制药工程' },
          { code: '0817Z2', name: '制药与精细化工' },
          { code: '0817Z3', name: '制药工程与技术' },
          { code: '0817Z4', name: '制药工程' },
        ],
      },
      {
        code: '0818',
        ...
        majors: [
          ...
          { code: '0818J1', name: '碳储科学与工程' },
          { code: '0818J2', name: '低空技术与工程' },
          { code: '0818J3', name: '水文学与水资源' },
          { code: '0818J7', name: '碳中和科学与工程' },
          { code: '0818J8', name: '地下新能源与碳储工程' },
          { code: '0818J9', name: '新能源科学与工程' },
          { code: '0818Z1', name: '旅游地质与地质遗迹' },
          { code: '0818Z2', name: '地球物理测井' },
          { code: '0818Z3', name: '地学信息工程' },
          { code: '0818Z4', name: '地下水科学与工程' },
        ],
      },
      {
        code: '0819',
        ...
        majors: [
          ...
          { code: '0819J1', name: '矿业贸易与投资' },
          { code: '0819J2', name: '新能源科学与工程' },
          { code: '0819J3', name: '应急技术与管理' },
          { code: '0819J4', name: '新能源科学与工程' },
          { code: '0819Z1', name: '金属矿选冶一体化' },
          { code: '0819Z3', name: '地下工程' },
        ],
      },
      {
        code: '0820',
        ...
        majors: [
          ...
          { code: '0820J1', name: '低空技术与工程' },
          { code: '0820J2', name: '能源智能科学与工程' },
          { code: '0820Z1', name: '海洋油气工程' },
          { code: '0820Z2', name: '石油矿场机械' },
          { code: '0820Z3', name: '井下控制工程' },
        ],
      },
      {
        code: '0821',
        ...
        majors: [
          ...
          { code: '0821Z5', name: '非织造材料与工程' },
          { code: '0821J8', name: '柔性功能电子器件与系统' },
          { code: '0821Z1', name: '纤维复合材料' },
          { code: '0821Z2', name: '智能电子纺织品与可穿戴技术' },
        ],
      },
      {
        code: '0822',
        ...
        majors: [
          ...
          { code: '0822J1', name: '监管科学' },
          { code: '0822Z1', name: '生物质能源与材料' },
          { code: '0822Z3', name: '生物质化学与材料工程' },
        ],
      },
      {
        code: '0823',
        ...
        majors: [
          ...
          { code: '0823J1', name: '城市交通' },
          { code: '0823J4', name: '低空技术与工程' },
          { code: '0823Z1', name: '交通安全与工程管理' },
          { code: '0823Z2', name: '交通工程' },
          { code: '0823Z3', name: '城市轨道交通工程' },
          { code: '0823Z4', name: '交通运输安全与环境工程' },
          { code: '0823Z5', name: '交通安全与环境' },
        ],
      },
      {
        code: '0824',
        ...
        majors: [
          ...
          { code: '0824J1', name: '海洋技术与工程' },
          { code: '0824J4', name: '极地装备技术与工程' },
          { code: '0824Z1', name: '船舶与海洋工程材料' },
          { code: '0824Z2', name: '救助与打捞工程' },
          { code: '0824Z3', name: '舰船电子工程技术' },
          { code: '0824Z4', name: '船舶化学电源技术' },
          { code: '0824Z5', name: '舰船通信天线技术' },
        ],
      },
      {
        code: '0825',
        ...
        majors: [
          ...
          { code: '0825J1', name: '低空技术与工程' },
          { code: '0825J2', name: '低空经济' },
          { code: '0825Z1', name: '航空噪声与振动工程' },
          { code: '0825Z2', name: '宇航元器件工程' },
        ],
      },
      {
        code: '0826',
        ...
        majors: [
          ...
          { code: '0826J1', name: '兵器智能技术' },
          { code: '0826Z1', name: '军用功能材料' },
          { code: '0826Z2', name: '国防教育工程' },
        ],
      },
      {
        code: '0827',
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '0828J1', name: '城乡建设工程与管理' },
          { code: '0828J2', name: '智慧农业' },
          { code: '0828J3', name: '农业人工智能' },
          { code: '0828Z1', name: '仿生科学与工程' },
          { code: '0828Z2', name: '农业系统工程与管理工程' },
          { code: '0828Z4', name: '智慧农业技术与装备' },
        ],
      },
      {
        code: '0829',
        ...
        majors: [
          ...
          { code: '0829J1', name: '森林防火' },
          { code: '0829J2', name: '家居智能设计与工程' },
          { code: '0829J5', name: '家具设计与工程' },
          { code: '0829J6', name: '低空技术与工程' },
          { code: '0829Z1', name: '家具设计与工程' },
          { code: '0829Z2', name: '生物质能源科学与技术' },
          { code: '0829Z3', name: '林业电气化与自动化' },
          { code: '0829Z4', name: '生物质能源与材料' },
        ],
      },
      {
        code: '0830',
        ...
        majors: [
          ...
          { code: '0830J1', name: '环境法医学' },
          { code: '0830J2', name: '环境科学与新能源技术' },
          { code: '0830J3', name: '海洋事务' },
          { code: '0830J5', name: '食品安全与健康' },
          { code: '0830J6', name: '安全科学与减灾' },
          { code: '0830J7', name: '碳中和科学与工程' },
          { code: '0830Z1', name: '市政环境' },
          { code: '0830Z2', name: '环境化学与新能源' },
        ],
      },
      {
        code: '0831',
        ...
        majors: [
          ...
          { code: '0831J4', name: '精准医学与公共健康' },
          { code: '0831Z1', name: '电子信息技术及仪器' },
          { code: '0831Z2', name: '智能医学工程' },
        ],
      },
      {
        code: '0832',
        ...
        majors: [
          ...
          { code: '0832J1', name: '低空技术与工程' },
          { code: '0832J2', name: '绿色储备科学与技术' },
          { code: '0832J4', name: '包装工程' },
          { code: '0832Z1', name: '烟草科学与工程' },
          { code: '0832Z2', name: '畜产品加工工程' },
          { code: '0832Z3', name: '食品环境与安全' },
          { code: '0832Z4', name: '烹饪科学' },
        ],
      },
      {
        code: '0833',
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '0835J1', name: '人工智能' },
          { code: '0835J2', name: '人工智能' },
          { code: '0835J4', name: '人工智能与绿色制造' },
          { code: '0835Z1', name: '大数据与数据科学' },
        ],
      },
      {
        code: '0836',
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '0837J1', name: '低空技术与工程' },
          { code: '0837J2', name: '低空技术与工程' },
          { code: '0837J5', name: '生态环境安全' },
          { code: '0837J6', name: '职业安全健康' },
          { code: '0837Z1', name: '信息安全工程' },
          { code: '0837Z3', name: '消防技术及工程' },
        ],
      },
      {
        code: '0838',
        ...
        majors: [
          ...
          { code: '0838Z1', name: '刑事科学技术' },
          { code: '0838Z2', name: '安全防范工程' },
          { code: '0838Z3', name: '交通管理工程' },
          { code: '0838Z4', name: '网络空间安全执法技术' },
        ],
      },
      {
        code: '0839',
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '0871J2', name: '流通工程与技术管理' },
          { code: '0871J3', name: '教育信息技术' },
          { code: '0871J6', name: '大数据管理与工程' },
          { code: '0871Z1', name: '物流工程' },
          { code: '0871Z2', name: '物流工程' },
        ],
      },
      {
        code: '0872',
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '0901J1', name: '生物育种' },
          { code: '0901J2', name: '智慧农业' },
          { code: '0901J3', name: '智慧农业' },
          { code: '0901J6', name: '智慧农业' },
          { code: '0901Z1', name: '作物种质资源学' },
          { code: '0901Z2', name: '区域农业发展' },
          { code: '0901Z3', name: '生物炭与作物生态环境' },
          { code: '0901Z4', name: '种子科学与工程' },
          { code: '0901Z5', name: '作物基因组与种质资源' },
          { code: '0901Z6', name: '菌类作物学' },
        ],
      },
      {
        code: '0902',
        ...
        majors: [
          ...
          { code: '090203', name: '茶学' },
          { code: '0902J1', name: '智慧园艺' },
          { code: '0902J2', name: '区域生态安全与绿色文化' },
          { code: '0902Z1', name: '观赏园艺' },
          { code: '0902Z2', name: '观赏园艺学' },
          { code: '0902Z3', name: '药用植物学' },
          { code: '0902Z4', name: '草坪资源与利用' },
          { code: '0902Z5', name: '智慧园艺' },
        ],
      },
      {
        code: '0903',
        ...
        majors: [
          ...
          { code: '0903J1', name: '农业生态环境' },
          { code: '0903J6', name: '乡村学' },
          { code: '0903Z1', name: '农业水资源与环境' },
          { code: '0903Z2', name: '农业环境保护' },
          { code: '0903Z3', name: '农业生态与气候变化' },
          { code: '0903Z4', name: '资源环境微生物学' },
          { code: '0903Z5', name: '资源环境微生物学' },
        ],
      },
      {
        code: '0904',
        ...
        majors: [
          ...
          { code: '0904J1', name: '菌物表型组学' },
          { code: '0904J2', name: '生物安全' },
          { code: '0904Z1', name: '菌物学' },
          { code: '0904Z2', name: '农产品安全' },
          { code: '0904Z3', name: '应用生物科学' },
          { code: '0904Z4', name: '生物防治学' },
        ],
      },
      {
        code: '0905',
        ...
        majors: [
          ...
          { code: '0905Z1', name: '动物健康养殖与安全生产' },
          { code: '0905Z2', name: '动物生产学' },
          { code: '0905Z3', name: '动物生产' },
          { code: '0905Z4', name: '智慧养殖与动物生产学' },
        ],
      },
      {
        code: '0906',
        ...
        majors: [
          ...
          { code: '0906Z1', name: '动物生物技术' },
          { code: '0906Z2', name: '兽药学' },
        ],
      },
      {
        code: '0907',
        ...
        majors: [
          ...
          { code: '0907J1', name: '国家公园学' },
          { code: '0907Z1', name: '园林植物学' },
          { code: '0907Z2', name: '城市林业' },
          { code: '0907Z3', name: '森林土壤学' },
          { code: '0907Z4', name: '森林学' },
          { code: '0907Z5', name: '森林生态学' },
        ],
      },
      {
        code: '0908',
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '1001J1', name: '分子医学' },
          { code: '1001J2', name: '分子医学' },
          { code: '1001J3', name: '再生医学' },
          { code: '1001J4', name: '生殖医学' },
          { code: '1001J6', name: '再生医学' },
          { code: '1001Z1', name: '人体生理学' },
          { code: '1001Z2', name: '人文医学' },
          { code: '1001Z3', name: '再生医学' },
          { code: '1001Z4', name: '医学化学' },
          { code: '1001Z5', name: '医学神经生物学' },
          { code: '1001Z6', name: '肿瘤生物治疗学' },
          { code: '1001Z8', name: '干细胞与再生医学' },
        ],
      },
      {
        code: '1002',
        ...
        majors: [
          ...
          { code: '1002J1', name: '临床研究方法学' },
          { code: '1002J2', name: '临床遗传学' },
          { code: '1002J3', name: '生殖医学' },
          { code: '1002J4', name: '临床遗传学' },
          { code: '1002J5', name: '临床营养学' },
          { code: '1002J6', name: '转化医学' },
          { code: '1002Z1', name: '临床心理学' },
          { code: '1002Z2', name: '临床中西医结合' },
          { code: '1002Z3', name: '临床口腔医学' },
          { code: '1002Z4', name: '临床心理学' },
          { code: '1002Z5', name: '临床病理学' },
          { code: '1002Z6', name: '临床遗传学' },
          { code: '1002Z7', name: '医学设备技术学' },
          { code: '1002Z8', name: '健康管理医学' },
          { code: '1002Z9', name: '输血医学' },
        ],
      },
      {
        code: '1003',
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '1004J1', name: '公共卫生安全与人兽共患病防控' },
          { code: '1004J4', name: '群医学' },
          { code: '1004J5', name: '人文医学' },
          { code: '1004J6', name: '医学信息学' },
          { code: '1004Z1', name: '健康教育与健康促进' },
          { code: '1004Z2', name: '健康教育与健康促进' },
          { code: '1004Z3', name: '健康教育与健康促进' },
          { code: '1004Z4', name: '社会医学与公共卫生管理' },
        ],
      },
      {
        code: '1005',
        ...
        majors: [
          ...
          { code: '1005J1', name: '中医药人工智能' },
          { code: '1005Z1', name: '中医优势治疗技术' },
          { code: '1005Z2', name: '中医临床药学' },
          { code: '1005Z3', name: '中医养生学' },
          { code: '1005Z4', name: '中医养生学' },
          { code: '1005Z5', name: '中医养生学' },
          { code: '1005Z6', name: '中医文化学' },
          { code: '1005Z7', name: '中医养生康复学' },
          { code: '1005Z8', name: '中医文化学' },
        ],
      },
      {
        code: '1006',
        ...
        majors: [
          ...
          { code: '1006J2', name: '中医药转化医学' },
          { code: '1006Z1', name: '中西医结合护理' },
          { code: '1006Z2', name: '中西医结合康复学' },
          { code: '1006Z3', name: '中医免疫学' },
          { code: '1006Z7', name: '中西医结合循证医学' },
          { code: '1006Z8', name: '中西医结合药理学' },
        ],
      },
      {
        code: '1007',
        ...
        majors: [
          ...
          { code: '1007J1', name: '动物药学' },
          { code: '1007J2', name: '农业药学' },
          { code: '1007Z1', name: '临床药学' },
          { code: '1007Z2', name: '中医药生物工程学' },
          { code: '1007Z3', name: '临床药学' },
          { code: '1007Z4', name: '临床药学' },
          { code: '1007Z5', name: '药学信息学' },
          { code: '1007Z6', name: '药物代谢动力学' },
          { code: '1007Z7', name: '医药大数据与人工智能' },
          { code: '1007Z8', name: '药物经济学' },
          { code: '1007Z9', name: '天然药物化学' },
        ],
      },
      {
        code: '1008',
        ...
        majors: [
          ...
          { code: '1008J2', name: '民族药学' },
          { code: '1008Z1', name: '海洋中药学' },
          { code: '1008Z2', name: '医学生物化学与分子生物学' },
          { code: '1008Z3', name: '中药药理学' },
          { code: '1008Z4', name: '中药分析学' },
          { code: '1008Z5', name: '中药药剂学' },
          { code: '1008Z6', name: '中药资源学' },
          { code: '1008Z7', name: '中药炮制学' },
          { code: '1008Z8', name: '中药鉴定学' },
        ],
      },
      {
        code: '1009',
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '1201J1', name: '财经人工智能' },
          { code: '1201J2', name: '低空技术与工程' },
          { code: '1201J3', name: '国际工程与语言服务' },
          { code: '1201J6', name: '安全科学与减灾' },
          { code: '1201Z1', name: '公共管理与城市文化' },
          { code: '1201Z2', name: '体育管理' },
          { code: '1201Z3', name: '信息管理与信息系统' },
          { code: '1201Z4', name: '大数据与商务分析' },
          { code: '1201Z5', name: '大数据管理' },
          { code: '1201Z8', name: '人工智能系统与应用' },
        ],
      },
      {
        code: '1202',
        ...
        majors: [
          ...
          { code: '1202J1', name: '流通经济与管理' },
          { code: '1202J2', name: '区域生态安全与绿色文化' },
          { code: '1202J3', name: '国际商务' },
          { code: '1202Z1', name: '人力资源管理' },
          { code: '1202Z2', name: '人力资源管理' },
          { code: '1202Z3', name: '人力资源管理' },
          { code: '1202Z4', name: '物流管理' },
          { code: '1202Z5', name: '市场营销管理' },
          { code: '1202Z6', name: '人力资源管理' },
          { code: '1202Z7', name: '审计学' },
          { code: '1202Z9', name: '物流与供应链管理' },
        ],
      },
      {
        code: '1203',
        ...
        majors: [
          ...
          { code: '1203J1', name: '生态文明建设' },
          { code: '1203J2', name: '国家公园学' },
          { code: '1203J6', name: '乡村学' },
          { code: '1203Z1', name: '乡村经济管理' },
          { code: '1203Z3', name: '农业技术经济' },
          { code: '1203Z5', name: '产业经济' },
        ],
      },
      {
        code: '1204',
        ...
        majors: [
          ...
          { code: '1204J1', name: '城市学' },
          { code: '1204J2', name: '宏观质量管理' },
          { code: '1204Z1', name: '公共组织与人力资源管理' },
          { code: '1204Z2', name: '人力资源管理' },
          { code: '1204Z3', name: '干部教育学' },
          { code: '1204Z4', name: '公共组织与人力资源管理' },
          { code: '1204Z5', name: '城市与区域管理' },
          { code: '1204Z6', name: '公共政策' },
        ],
      },
      {
        code: '1205',
        ...
        majors: [
          ...
          { code: '1205Z1', name: '出版发行学' },
          { code: '1205Z2', name: '大数据管理与应用' },
          { code: '1205Z3', name: '保密管理' },
        ],
      },
      {
        code: '1271',
    ...
    disciplines: [
      {
        ...
        majors: [
          ...
          { code: '1301Z1', name: '动画学' },
          { code: '1301J1', name: '艺术经济与管理' },
        ],
      },
      {
        code: '1370',
    ...
    disciplines: [
      ...
      },
      {
        ...
        majors: [
          ...
          { code: '1403J1', name: '景观规划设计' },
          { code: '1403Z1', name: '产品创意设计' },
        ],
      },
      {
        code: '1404',
        ...
        majors: [
          ...
          { code: '1404J1', name: '低空技术与工程（低空智能航行技术）' },
          { code: '1404J7', name: '低空技术与工程' },
        ],
      },
      {
        code: '1405',
        ...
        majors: [
          ...
          { code: '1405J1', name: '低空技术与工程' },
          { code: '1405J7', name: '低空技术与工程' },
          { code: '1405Z1', name: '低空安全保障技术' },
        ],
      },
      {
        code: '1406',
